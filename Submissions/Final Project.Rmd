...
```
MAPE of ARIMA model is 64.59397
...
# Finding Maximum Count for Trump and Clinton
## Trump
df_2016 <- subset(trump_pageviews_daily, substr(date, 1, 4) == "2016")
df2_2016 <- subset(clinton_pageviews_daily, substr(date, 1, 4) == "2016")
max(df_2016$views); max(df2_2016$views)
```
