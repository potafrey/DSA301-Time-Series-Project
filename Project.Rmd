...
# There are significant lags in r1,2,3 and in r19 to 24
lambda <- BoxCox.lambda(obama_ts_DA)
obama_bc <- BoxCox(obama_ts_DA, lambda)
autoplot(obama_bc)
...
#train-test split
obama_train <- window(obama_ts_DA, )
...
# Build complex model
## ARIMA
nsdiffs(obama_ts_DA) #returns 0
ndiffs(obama_ts_DA) #returns 1

#----------
#auto arima
obama_auto_arima <- auto.arima(obama_ts_DA, lambda = lambda)
obama_auto_arima #auto arima returned ARIMA(0,1,1)(0,0,1)
